              ...
              children: [
                ...
                Row(children: [
                  Container(
                    ...
                    child: Icon(Icons.storefront, color: NusaConfig.accentPurple, size: 20),
                  ),
                  SizedBox(width: 12),
                  Text(
                ...
                Row(children: [
                  ...
                  SizedBox(width: 10),
                  _statusChip('Tutup', status, Color(0xFF9CA3AF), isDark,
                ...
                if (existing != null) ...[
                  ...
                  TextButton(
                    ...
                    child:  Text('Hapus Cabang', style: TextStyle(color: NusaConfig.activePrimary)),
                  ),
                ],
              ],
            ),
  ...
  Widget _statusChip(String label, String current, Color color, bool isDark, {required VoidCallback onTap}) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected ? color.withValues(alpha: 0.12) : (isDark ? NusaConfig.darkSurface2 : Color(0xFFF3F4F6)),
  ...
  Widget build(BuildContext context) {
    ...
    return ScreenScaffold(
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  ...
                                  border: Border(
                                    left: BorderSide(
                                      color: isActive ? NusaConfig.accentGreen : Color(0xFF9CA3AF),
                                      width: 4,
                                    ),
                                  ),
                                ),
                                    ...
                                    child: Row(
                                      children: [
                                        Container(
                                          ...
                                          height: 44,
                                          decoration: BoxDecoration(
                                            color: (isActive ? NusaConfig.accentGreen : Color(0xFF9CA3AF)).withValues(alpha: 0.12),
                                            borderRadius: BorderRadius.circular(12),
                                          ),
                                          child: Icon(
                                            Icons.storefront,
      ...
      floatingActionButton: FloatingActionButton.extended(
        icon: Icon(Icons.add),
        label: Text('Tambah Cabang', style: TextStyle(fontWeight: FontWeight.w600)),
        backgroundColor: NusaConfig.activePrimary,
        foregroundColor: Colors.white,
        elevation: 4,
        onPressed: () => _showForm(),
